...
from transformers import (get_linear_schedule_with_warmup,
                          ...
                          PLBartConfig, PLBartForSequenceClassification, PLBartTokenizer)
...
MODEL_CLASSES = {'vanilla': {RobertaConfig, RobertaModel, RobertaTokenizer},
...
def main():
    ...
    if args.model_type == 'plbart':
        tokenizer = tokenizer_class.from_pretrained(args.tokenizer_name, src_lang='java')
    else:
