...
from utils import get_filenames, get_elapse_time, load_and_cache_qa_data
...
def main():
    ...
    model = QAModel(model, config, tokenizer, args)
    ...
    if args.do_train:
        ...
        train_examples, train_data = load_and_cache_qa_data(args, args.train_filename, pool, tokenizer, 'train',
                                                            is_sample=False)
        ...
        # for cur_epoch in range(3):
            ...
            if args.do_eval:
                ...
                eval_examples, eval_data = load_and_cache_qa_data(args, args.dev_filename, pool, tokenizer,
    ...
    if args.do_test:
        ...
        for criteria in ['best-acc']:
            ...
            eval_examples, eval_data = load_and_cache_qa_data(args, args.test_filename, pool, tokenizer, 'test',
                                                              is_sample=False)
