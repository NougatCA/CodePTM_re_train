...
def add_args(parser):
    parser.add_argument("--task", type=str, required=True,
                        choices=['summarize', 'concode', 'translate', 'refine', 'defect', 'clone', 'multi_task', 'qa',
                                 'search', 'retrieval', "exception", "completion", "mutant", "assert",
                                 "completion-line", "cosqa"])
    parser.add_argument("--sub_task", type=str, default='')
    parser.add_argument("--lang", type=str, default='')
    parser.add_argument("--eval_task", type=str, default='')
    parser.add_argument("--model_type", default="codet5", type=str, choices=['roberta', 'bart', 'codet5', 'gpt2', 't5', 'plbart', "vanilla-bart"])
...
def set_dist(args, accelerator=None):
