...
from utils import get_filenames, get_elapse_time, load_and_cache_exception_data, get_exception_type_list
...
def main():
    ...
    model = ExceptionModel(model, config, tokenizer, args, num_labels=len(type_list))
    ...
    if args.do_train:
        ...
        train_examples, train_data = load_and_cache_exception_data(args, args.train_filename, pool, tokenizer, 'train',
                                                                   type_list=type_list,
                                                                   is_sample=False)
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            if args.do_eval:
                ...
                eval_examples, eval_data = load_and_cache_exception_data(args, args.dev_filename, pool, tokenizer,
                                                                         'valid', type_list=type_list, is_sample=False)
    ...
    if args.do_test:
        ...
        for criteria in ['best-acc']:
            ...
            eval_examples, eval_data = load_and_cache_exception_data(args, args.test_filename, pool, tokenizer, 'test',
                                                                     type_list=type_list,
                                                                     is_sample=False)
